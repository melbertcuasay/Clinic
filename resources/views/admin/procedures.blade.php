        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        <tr>
                            <th>Type of Skin Treatment</th>
                            <th>Procedures</th>
                            <th>Product Image</th>
                        </tr>
                    </thead>

                    @foreach($procedures as $procedures)
                    <tbody>
                        <tr>
                            <td>{{ $procedures->skin_treatment }}</td>
                            <td>{{ $procedures->procedures }}</td>
                            <td><img src="assets/uploads/procedures/{{ $procedures->image }}" alt=""></td>
                        </tr>
                    </tbody>
                    @endforeach
